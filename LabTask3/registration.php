...
<body>
    ...
    $emailErr=$cuPassErr=$rnewPassErr=$newPassErr=$rcpassErr=$rpass=$unameErr=$dobErr=$mmErr=$yyyyErr=$genderErr=$proNameErr=$misPassErr=$rnameErr=$rpassErr=$msgErr=$error='';
